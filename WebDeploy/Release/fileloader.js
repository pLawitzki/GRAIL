...
(function() {
    ...
    var PACKAGE_NAME = 'WebDeploy.data';
    var REMOTE_PACKAGE_BASE = 'WebDeploy.data';
    ...
    var PACKAGE_UUID = '76035d16-5dde-4192-aab5-88997e8f6442';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(173460, 241696, 0, 0).open('GET', '/level4');
    new DataRequest(241696, 307676, 0, 0).open('GET', '/level5');
    new DataRequest(307676, 378324, 0, 0).open('GET', '/level6');
    new DataRequest(378324, 409788, 0, 0).open('GET', '/level7');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebDeploy.data');

    };
    Module['addRunDependency']('datafile_WebDeploy.data');
